 ...
 const formik =  useFormik({
  ...
  :<div className="w-1/2 mx-auto mt-4">
      ...
      <form className="my-5" onSubmit={formik.handleSubmit} >
        ...
        <button type="submit" className="text-white bg-emerald-700 hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800">verify</button>
